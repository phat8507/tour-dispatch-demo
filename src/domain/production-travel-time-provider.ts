...
export type TravelResult = Readonly<{ id: string; kind: "ESTIMATE"; durationSeconds: number; distanceMeters?: number }> | Readonly<{ id: string; kind: "UNAVAILABLE"; reason: TravelUnavailableReason }>;
